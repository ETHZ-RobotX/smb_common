...
--MAPPER_LOCALIZER
params.mapper_localizer.is_merge_scans_into_map = false --Set this to True if you want to update the map on the fly
...
--MAP_INITIALIZER
params.map_initializer.pcd_file_path = "" --Make sure to set the correct path in launch file (default is $(find smb_slam)/data/maps/map.pcd)
...
params.map_initializer.frame_id = "map_o3d"
